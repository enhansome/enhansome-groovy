...
* [Spock](https://github.com/spockframework/spock) ⭐ 3,630 | 🐛 209 | 🌐 Java | 📅 2026-09-15 - The Enterprise-ready testing and specification framework.
...
* [GPars](https://github.com/GPars/GPars) ⭐ 249 | 🐛 22 | 🌐 Groovy | 📅 2023-12-16 - The GPars concurrency and parallelism framework for the JVM
...
* [picocli](https://github.com/remkop/picocli) ⭐ 5,425 | 🐛 174 | 🌐 Java | 📅 2026-08-16 - Parser library and framework for CLI. Usage help with ANSI colors. Autocomplete. Nested subcommands and more.
...
* [Groovy's source](https://github.com/apache/groovy) ⭐ 5,468 | 🐛 11 | 🌐 Groovy | 📅 2026-09-15 - Groovy's source code mirrored on Github
...
To all the awesome-\* repos out there and their aggreators like [this](https://github.com/erichs/awesome-awesome) ⭐ 296 | 🐛 3 | 📅 2023-11-13 and [this](https://github.com/bayandin/awesome-awesomeness) ⭐ 33,674 | 🐛 65 | 🌐 Ruby | 📅 2024-06-02.
